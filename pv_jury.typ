...
#let content = [
  ...
  #align(center)[
    #table(
      ...
      [
        *Note globale*#footnote($"Note globale" = 0.3 times "note de l'encadrant" + 0.3 times "note du rapporteur" + 0.4 times "note de la soutenance"$) _(20 points)_
      ], [ #evaluation.ntot ],
    )
  ]
  ...
  #set table(fill: luma(230).lighten(70%))
